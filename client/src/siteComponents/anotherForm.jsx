          ...
          <div className="grid grid-cols-3 ml-24">
            ...
            <div className="col-span-2">
              ...
              <div className="flex flex-row">
                <p>Paybill:</p>
                <p className="font-bold">522522</p>
              </div>
              <div className="flex flex-row">
                <p>AccNo:</p>
                <p className="font-bold">1226041175</p>
              </div>
            </div>
          </div>
        </div>
